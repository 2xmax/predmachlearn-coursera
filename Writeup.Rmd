...
For best accurancy without requirement of good interpretaion the best choice will be random forests algorithm (at least among RF, GBM and SVM. Look for code.R for details).
```{r}
