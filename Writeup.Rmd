...
The original dataset has a lot of noise, let us clean it.
```{r}
...
In order to achieve the best accuracy without requirement of good model interpretation the best choice will be random forests algorithm (at least among RF, GBM and SVM. Look for [code.R](https://github.com/2xmax/predmachlearn-coursera/blob/master/code.R) for details).
```{r}
