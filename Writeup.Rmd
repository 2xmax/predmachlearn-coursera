...
This paper deals with prediction of human acrtivities based on collected data using devices such as Jawbone Up, Nike FuelBand, and Fitbit. The research is based upon this paper <http://groupware.les.inf.puc-rio.br/har>.

Initization of environment
===============================
...
And set some seed to make my expirement reproduceble
